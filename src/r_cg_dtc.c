...
void R_DTC_Create(void)
{
    ...
    dtc_controldata_0.dtccr = _01_DTC_TRANSFER_MODE_REPEAT | _40_DTC_DATA_SIZE_16BITS | _00_DTC_REPEAT_AREA_DEST |
                              _00_DTC_SOURCE_ADDR_FIXED | _00_DTC_CHAIN_TRANSFER_DISABLE | _00_DTC_REPEAT_INT_DISABLE;
    ...
    dtc_controldata_0.dtsar = _FF1F_DTCD0_SRC_ADDRESS;
    dtc_controldata_0.dtdar = _A000_DTCD0_DEST_ADDRESS;
}
