...
#define _0C7E_TMRD_TRDGRA0_VALUE                (0x0C7EU)
/* TMRD register B0 (TRDGRB0) */
#define _0C5F_TMRD_TRDGRB0_VALUE                (0x0C5FU)
/* TMRD register D0 (TRDGRD0) */
#define _0C5F_TMRD_TRDGRD0_VALUE                (0x0C5FU)
/* TMRD register A1 (TRDGRA1) */
#define _0C5F_TMRD_TRDGRA1_VALUE                (0x0C5FU)
/* TMRD register B1 (TRDGRB1) */
#define _0C5F_TMRD_TRDGRB1_VALUE                (0x0C5FU)
/* TMRD register C1 (TRDGRC1) */
#define _0C5F_TMRD_TRDGRC1_VALUE                (0x0C5FU)
/* TMRD register D1 (TRDGRD1) */
#define _0C5F_TMRD_TRDGRD1_VALUE                (0x0C5FU)
/* TMRD counter register 0 (TRD0) */
#define _0000_TMRD_RD0_VALUE                    (0x0000U)
